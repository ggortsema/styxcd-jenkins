...
class DummyWorkflowInitialize implements Serializable {
    /**
     ...
     */
    public DummyWorkflowInitialize(steps, featureFlags) {
        this.steps = steps
    ...
    public void runStage(script, params, keyMaps) {
      ...
      metricsUtil.addStageToSplunkMap(script, "DummyWorkflowInitialize*", startTime, null, keyMaps)
      ...
      steps.echo "in dummy init stage"

      def endTime = System.currentTimeMillis()
      metricsUtil.addStageToSplunkMap(script, "DummyWorkflowInitialize*", startTime, endTime, keyMaps)
    }
}
