...
class DummyWorkflowCleanup implements Serializable {
    /**
     ...
     */
    public DummyWorkflowCleanup(steps, featureFlags) {
        this.steps = steps
    ...
    public void runStage(script, params, keyMaps) {
      ...
      metricsUtil.addStageToSplunkMap(script, "DummyWorkflowCleanup*", startTime, null, keyMaps)
      ...
      steps.echo "in dummy cleanup stage"

      def endTime = System.currentTimeMillis()
      metricsUtil.addStageToSplunkMap(script, "DummyWorkflowCleanup*", startTime, endTime, keyMaps)
